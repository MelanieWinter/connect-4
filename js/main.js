...
//     // rotate the board 90 degreets counter-clockwise
//     board = [
//         [0, 0, 0, 0, 0, 0], //col 0
//         [0, 0, 0, 0, 0, 0], //col 1
//         [0, 0, 0, 0, 0, 0], //col 2
...
//     // ternary expression is the go to when you want 1 if 2 values returned
//     // <cond expr> ? <truthy expr> : <falsy expr>
//     playAgainBtn.style.visibility = winner ? 'visible' : 'hidden';
//     // iterate over the marker element to hide/show
//     // according to the column being full (no 0's) or not
//     markerEls.forEach(function(markerEl, colIdx) {
//         const hideMarker = !board[colIdx].includes(0);
//         markerEl.style.visibility = hideMarker ? 'hidden' : 'visible';
//     });
// }

// // in response to user interaction, update all impacter
// // state, then call rander();
